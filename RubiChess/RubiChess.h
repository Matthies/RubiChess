...
struct evalparamset {
    ...
    eval eComplexpasserbonus = EVALUE(0);
    eval eComplexpawnsbonus = EVALUE(0);
    eval eComplexpawnflanksbonus = EVALUE(0);
    eval eComplexonlypawnsbonus = EVALUE(0);
    eval eComplexadjust = EVALUE(0);
