...
struct searchparamset {
...
#else
    searchparam SP(deltapruningmargin, 286, 40, 300);
#endif
    // LMR table
    ...
    // Correction history
    searchparam SP(correctionhistoryratio, 110, 64, 192);
    // NNUE eval scale
