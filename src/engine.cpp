...
void engine::resetEndTime(U64 nowTime, int constantRootMoves, int bestmovenodesratio)
{
    ...
    if (movestogo)
    {
        ...
        U64 f1 = max(9 - movevariation, 21 - movevariation - constance) * bestmovenodesratio * (2 + firstmovebonus) / 2;
        U64 f2 = max(19, 31 - constance) * bestmovenodesratio * (2 + firstmovebonus) / 2;
        ...
        if (timeinc)
        {
            ...
            U64 f1 = max(5, 17 - constance) * bestmovenodesratio * (2 + firstmovebonus) / 2;
            U64 f2 = max(15, 27 - constance) * bestmovenodesratio * (2 + firstmovebonus) / 2;
            ...
            int f1 = min(42, 30 + constance)  * (2 + firstmovebonus) / 2;
            int f2 = min(22, 10 + constance)  * (2 + firstmovebonus) / 2;
