...
void chessposition::resetStats()
{
    ...
    memset(minorscorrectionhistory, 0, sizeof(chessposition::minorscorrectionhistory));
    memset(majorscorrectionhistory, 0, sizeof(chessposition::majorscorrectionhistory));
    for (int i = 0; i < 6; i++)
